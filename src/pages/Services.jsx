    ...
    <Navbar/>
        ...
        <Box className={classes.mainbox}>
            <Box className={classes.linearbox} >
                    <Link to ={"./Vendors"} style={{textDecoration:'none',color:'black'}}>
        ...
        <Box className={classes.linearbox} >
            ...
            <img src="https://images.pexels.com/photos/4042486/pexels-photo-4042486.jpeg?cs=srgb&dl=pexels-krishna-studio-4042486.jpg&fm=jpg" style={{height:'120px',width:'222px',marginLeft:'138px',borderTopLeftRadius:'56px',}}/></Box>

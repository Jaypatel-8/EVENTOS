    ...
    return (<>
        ...
        <Box className={classes.mainBox}>
            ...
            <Box className={classes.right}>
                <Typography style={{ fontSize: "20px", marginTop: "30px" }}>Brand:{profiles.brandname}</Typography>
                <Typography style={{ fontSize: "20px", marginTop: "30px" }}>Email: {profiles.email}</Typography>
                <Typography style={{ fontSize: "20px", marginTop: "30px" }}>Vendor Type:{profiles.vendortype}</Typography>
                <Typography style={{ fontSize: "20px", marginTop: "30px" }}>City: {profiles.city}</Typography>
                <Typography style={{ fontSize: "20px", marginTop: "30px" }}>Address:{profiles.address}</Typography>
                <Typography style={{ fontSize: "20px", marginTop: "30px" }}>Phone: {profiles.number}</Typography>
